...
export const INITIAL_APP_DATA: AppData = {
  classes: [],
  program: {
    title: "Programme Annuel FLE",
    goals: ["Atteindre le niveau A2 du CECRL.", "Améliorer la fluidité à l'oral.", "Maîtriser les temps du passé."],
    modules: [
      { id: "m1", title: "Module 1: Découvertes", topics: ["Se présenter", "La famille", "Les nationalités"] },
      { id: "m2", title: "Module 2: La vie quotidienne", topics: ["Les habitudes", "La nourriture", "Les transports"] }
    ]
  },
  lessons: [],
  activities: [],
...
export const NAVIGATION_ITEMS: { view: View; label: string; icon: JSX.Element }[] = [
  {
    view: 'DASHBOARD',
